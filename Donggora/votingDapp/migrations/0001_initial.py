...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('문과대학', '문과대학'), ('이과대학', '이과대학'), ('불교대학', '불교대학'), ('법과대학', '법과대학'), ('사회과학대학', '사회과학대학'), ('경찰사법대학', '경찰사법대학'), ('경영대학', '경영대학'), ('바이오시스템대학', '바이오시스템대학'), ('공과대학', '공과대학'), ('사범대학', '사범대학')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Poll',
