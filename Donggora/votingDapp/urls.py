...
urlpatterns = [
    ...
    path('vote_specifications/pros/<int:id>', views.vote_specifications_pros, name='vote_specifications_pros'),
    path('vote_specifications/cons/<int:id>', views.vote_specifications_cons, name='vote_specifications_cons'),
